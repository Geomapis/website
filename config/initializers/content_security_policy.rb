...
Rails.application.configure do
  connect_src = [:self]
  img_src = [:self, :data, "37.186.119.202:8081", "37.186.119.202:8082", "www.gravatar.com", "*.wp.com", "tile.openstreetmap.org", "gps.tile.openstreetmap.org", "*.tile.thunderforest.com", "tile.tracestrack.com", "*.openstreetmap.fr"]
  script_src = [:self]
