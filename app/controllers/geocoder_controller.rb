class GeocoderController < ApplicationController
  ...
  def search_osm_nominatim
    ...
    @more_params = params
                   .permit(:query, :minlon, :minlat, :maxlon, :maxlat, :exclude, :xhr, :zoom, :authenticity_token)
  ...
  def normalize_params
    ...
    params.permit(:query, :lat, :lon, :latlon_digits, :zoom, :minlat, :minlon, :maxlat, :maxlon, :xhr)
  end
